...
class Hand:
    ...
    def strength(self):
        ...
        if "J" in rank_count and rank_count["J"] != 5:
            j_count = rank_count.pop("J")
            high_count = rank_count.most_common(1)[0][0]
            rank_count = dict(rank_count)
            rank_count[high_count] += j_count
            rank_count = Counter(rank_count)
